...
const dataURL = "http://api.exchangeratesapi.io/v1/latest?access_key=6cddb2a38235f6f2fa0096c9eeb8303d";

const initiallyDisplayedCurrencies = ["INR", "USD", "EUR", "JPY", "RUB"];
let baseCurrency;
